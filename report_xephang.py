...
body{background:radial-gradient(135% 95% at 50% -12%,rgba(167,139,250,.36),transparent 70%),#22124a !important;background-attachment:fixed}
.top{background:linear-gradient(180deg,#22124a 60%,rgba(34,18,74,0)) !important}
</style></head><body>"""

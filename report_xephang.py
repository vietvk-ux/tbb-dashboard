...
body{background:radial-gradient(120% 62% at 50% -5%,rgba(139,92,246,.24),transparent 60%),radial-gradient(100% 55% at 92% 16%,rgba(168,85,247,.14),transparent 60%),#0f0a1c !important;background-attachment:fixed}
.top{background:linear-gradient(180deg,#120b22 62%,rgba(18,11,34,0)) !important}
</style></head><body>"""

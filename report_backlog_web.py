...
.muted{color:var(--mut)}
body{background:radial-gradient(135% 95% at 50% -12%,rgba(251,146,60,.34),transparent 70%),#32200a !important;background-attachment:fixed}
.top{background:linear-gradient(180deg,#32200a 60%,rgba(50,32,10,0)) !important}
</style>"""

...
body{background:radial-gradient(135% 95% at 50% -12%,rgba(52,211,153,.36),transparent 70%),#0c3021 !important;background-attachment:fixed}
.top{background:linear-gradient(180deg,#0c3021 60%,rgba(12,48,33,0)) !important}
</style></head><body>"""
